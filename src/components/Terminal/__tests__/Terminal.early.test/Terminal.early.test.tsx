...
jest.mock('../TerminalHeader', () => jest.fn(() => <div>TerminalHeader</div>));
jest.mock('../TerminalOutput', () => jest.fn(() => <div>TerminalOutput</div>));
jest.mock('../TerminalPrompt', () => jest.fn(() => <div>TerminalPrompt</div>));
...
describe('Terminal() Terminal method', () => {
  describe('Happy Paths', () => {
    ...
    test('handles command submission', () => {
      ...
      // Check if sendCommand was called
      expect(sendCommand).toHaveBeenCalledWith('test command');
    });
  });
  ...
  describe('Edge Cases', () => {
    test('handles empty command submission', () => {
      ...
      // Check if sendCommand was not called
