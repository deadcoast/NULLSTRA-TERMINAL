      ...
      Command_History: {
        ...
        children: {
          ...
          '[User:4205-ANLY].log': {
            ...
            content:
              'Analysis operations performed by NULLSTRA analytics division.',
          },
          '[User:4587-SRVC].log': {
            type: 'file',
            name: '[User:4587-SRVC].log',
            content:
              'Service operations performed by NULLSTRA technical division.',
          },
          '[User:4587-CRMC].log': {
            type: 'file',
          ...
          '[User:6742-NEWS].log': {
            ...
            content:
              'Information retrieval operations by NULLSTRA media division.',
          },
          '[User:8117-CAPT].log': {
            type: 'file',
          ...
          '[User:8902-EXPL].log': {
            ...
            content:
              'Exploration operations performed by NULLSTRA survey team.',
          },
        },
      },
      Commerce: {
