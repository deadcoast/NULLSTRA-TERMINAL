...
const pingCommand: Command = {
  ...
  usage: 'ping <host>',
  examples: ['ping server', 'ping 192.168.1.1', 'ping quantum.node'],
  executor: (args, context) => {
    ...
    return [
      ...
      createInfoMessage(
        `64 bytes from ${host}: icmp_seq=0 ttl=64 time=${Math.random() * 10 + 1}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        `64 bytes from ${host}: icmp_seq=1 ttl=64 time=${Math.random() * 10 + 1}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        `64 bytes from ${host}: icmp_seq=2 ttl=64 time=${Math.random() * 10 + 1}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        `64 bytes from ${host}: icmp_seq=3 ttl=64 time=${Math.random() * 10 + 1}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      ...
      createInfoMessage(
        'round-trip min/avg/max/stddev = 1.123/4.567/9.876/2.345 ms',
        {
          animated: true,
        }
      ),
...
const netstatCommand: Command = {
  ...
  examples: ['netstat', 'netstat -a', 'netstat -r'],
  executor: (args, context) => {
    ...
    if (options.includes('-r')) {
      ...
      return [
        ...
        createInfoMessage(
          'quantum.local   0.0.0.0         255.255.255.0   U         0 0          0 qnet0',
          {
            animated: true,
          }
        ),
      ...
      return [
        ...
        createInfoMessage(
          'tcp        0     64 localhost:44231         server-2.local:https    ESTABLISHED',
          {
            animated: true,
          }
        ),
        createInfoMessage(
          'udp        0      0 *:bootpc                *:*                     ESTABLISHED',
          {
            animated: true,
          }
        ),
        createInfoMessage(
          'tcp        0      0 quantum.node:55123      remote-server:ssh       ESTABLISHED',
          {
            animated: true,
          }
        ),
  ...
  executor: (args, context) => {
    if (args.length === 0) {
      return createErrorMessage(
        'No server specified. Usage: connect <server> [port]'
      );
    }
    ...
    return [
      createInfoMessage(
        `Connecting to ${server}${port !== 'default' ? ` on port ${port}` : ''}...`,
        {
          animated: true,
        }
      ),
      ...
      createInfoMessage(
        'Link failure detected at node 4A-7D. Network integrity scan initiated.',
        {
          animated: true,
        }
      ),
      createInfoMessage(
        'Latency spikes observed. External interference or signal degradation suspected.',
        {
          animated: true,
        }
      ),
...
const disconnectCommand: Command = {
  ...
  examples: ['disconnect', 'disconnect quantum.server'],
  executor: (args, context) => {
...
const tracerouteCommand: Command = {
  ...
  executor: (args, context) => {
    ...
    return [
      createInfoMessage(
        `traceroute to ${host} (${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}), 30 hops max, 60 byte packets`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        ` 1  gateway (192.168.1.1)  ${Math.random() * 5 + 1}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 5 + 1}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 5 + 1}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        ` 2  edge-router.local (10.0.0.1)  ${Math.random() * 10 + 5}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 10 + 5}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 10 + 5}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        ` 3  core-switch-1.net (172.16.0.1)  ${Math.random() * 15 + 10}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 15 + 10}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 15 + 10}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        ` 4  quantum-gate.net (172.31.0.1)  ${Math.random() * 20 + 15}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 20 + 15}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 20 + 15}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
      createInfoMessage(
        ` 5  ${host} (${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)}.${Math.floor(Math.random() * 255)})  ${Math.random() * 25 + 20}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 25 + 20}.${Math.floor(Math.random() * 999)} ms  ${Math.random() * 25 + 20}.${Math.floor(Math.random() * 999)} ms`,
        {
          animated: true,
        }
      ),
